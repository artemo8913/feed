...
export const StatsDatePicker = ({ formattedDate, setStatsDate, statsDate }: StatsDatePickerProps) => {
    ...
    return (
        <div className={style.datePicker}>
            <button className={style.button} disabled={statsDate === StatsDateEnum.yesterday} onClick={prevClickHandle}>
                <Prev className={style.svg} />
            </button>
            <span className={style.date}>{formattedDate}</span>
            <button className={style.button} disabled={statsDate === StatsDateEnum.tomorrow} onClick={nextClickHandle}>
